return {
	colorscheme = function() 
		...
		vim.api.nvim_set_hl(0, "GitSignsAddInline", {fg="NONE", sp="#addb67", ctermfg="NONE", ctermbg="NONE",  bold = (vim.g.aurora_bold==1), underline= true })
		vim.api.nvim_set_hl(0, "GitSignsDeleteInline", {fg="NONE", sp="#E7C547", ctermfg="NONE", ctermbg="NONE",  bold = (vim.g.aurora_bold==1), undercurl= true })
		vim.api.nvim_set_hl(0, "GitSignsChangeInline", {fg="NONE", sp="#B376B3", ctermfg="NONE", ctermbg="NONE",  bold = (vim.g.aurora_bold==1), undercurl= true })
		...
		vim.api.nvim_set_hl(0, "ClapMatches", {fg="#C33C4A", sp="#f05874", ctermfg=131, ctermbg=238,  bold = (vim.g.aurora_bold==1), undercurl= true , reverse= true })
		vim.api.nvim_set_hl(0, "ClapDisplay", {fg="#aab7cf", sp="#f05874", ctermfg=146, ctermbg=234,  bold = (vim.g.aurora_bold==1), undercurl= true })
		...
		vim.api.nvim_set_hl(0, "TSConstant", {fg="#fbfcbf",  ctermfg=229,   bold = (vim.g.aurora_bold==1)})
		...
		vim.api.nvim_set_hl(0, "TSDefinition", {fg="#ff5874",  ctermfg=204,   bold = (vim.g.aurora_bold==1)})
		...
		vim.api.nvim_set_hl(0, "TSCurrentScope", { bg="#211c2f",  ctermbg=234,  bold = (vim.g.aurora_bold==1)})
		...
		vim.api.nvim_set_hl(0, "LightspeedLabel", {fg="#e7d3fb", sp="#ecc48d", ctermfg=189, ctermbg=54,  bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
		...
		vim.api.nvim_set_hl(0, "LspReferenceText", { sp="#FD9720",  ctermbg=239,  bold = (vim.g.aurora_bold==1), undercurl= true })
		vim.api.nvim_set_hl(0, "LspReferenceRead", {fg="#1aad16", sp="#FD9720", ctermfg=34,   bold = (vim.g.aurora_bold==1), undercurl= true })
		vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg="#1aad16", sp="#FD9720", ctermfg=34,   bold = (vim.g.aurora_bold==1), undercurl= true })
		vim.api.nvim_set_hl(0, "LspFloatWinNormal", {fg="#dacfb4", bg="#30234f", ctermfg=187, ctermbg=236,  })
		vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", {fg="NONE", sp="#fbec9f", ctermfg="NONE", ctermbg=53,  bold = (vim.g.aurora_bold==1), underline= true , italic= true })
		...
		vim.api.nvim_set_hl(0, "CursorLineNr", {fg="#1aad16", bg="#1a1926", ctermfg=34, ctermbg=234,  bold = (vim.g.aurora_bold==1)})
		...
		vim.api.nvim_set_hl(0, "DiffChange", {fg="NONE", bg="#282E39", ctermfg="NONE", ctermbg=236,  bold = (vim.g.aurora_bold==1)})
		vim.api.nvim_set_hl(0, "DiffDelete", {fg="NONE", bg="#4f5070", ctermfg="NONE", ctermbg=239,  bold = (vim.g.aurora_bold==1)})
		...
		vim.api.nvim_set_hl(0, "IncSearch", {fg="NONE", sp="#ecc48d", ctermfg="NONE", ctermbg=54,  bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
		vim.api.nvim_set_hl(0, "MatchParen", {fg="#EE82EE", sp="#E7C547", ctermfg=213, ctermbg="NONE",  bold = (vim.g.aurora_bold==1), undercurl= true })
		...
		vim.api.nvim_set_hl(0, "Search", {fg="NONE", sp="#B376B3", ctermfg="NONE", ctermbg=239,  bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
		...
		vim.api.nvim_set_hl(0, "Define", {fg="#88dfe9",  ctermfg=116,   italic = (vim.g.aurora_italic==1)})
		...
		vim.api.nvim_set_hl(0, "Error", {fg="#DC143C", sp="#e7dc8c", ctermfg=161, ctermbg="NONE",  bold = (vim.g.aurora_bold==1), undercurl= true })

...
local link_ts_v7 = function(bg)
  if vim.fn.has('nvim-0.8') == 0 then
    ...
    vim.api.nvim_set_hl(
      0,
      'TSPunctSpectial',
      { fg = '#E7C547', bg = bg, ctermfg = 185, ctermbg = 'NONE' }
    )
    vim.api.nvim_set_hl(0, 'TSConstant', { link = 'Constant' })
    vim.api.nvim_set_hl(
      0,
      'TSConstBuiltin',
      { fg = '#e73c50', ctermfg = 167, italic = (vim.g.aurora_italic == 1) }
    )
    ...
    vim.api.nvim_set_hl(
      0,
      'TSTypeBuiltin',
      { fg = '#ffce51', ctermfg = 221, bold = (vim.g.aurora_bold == 1) }
    )
    ...
    vim.api.nvim_set_hl(
      0,
      'TSConstructor',
      { fg = '#6690c4', ctermfg = 68, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(
      0,
      'TSFunction',
      { fg = '#66d9ef', ctermfg = 81, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(
      0,
      'TSKeywordFunction',
      { fg = '#0fb9e0', ctermfg = 38, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(
      0,
      'TSFunctionBuiltin',
      { fg = '#A6E22D', ctermfg = 148, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(
      0,
      'TSFuncBuiltin',
    ...
    vim.api.nvim_set_hl(
      0,
      'TSFuncMacro',
      { fg = '#be9af7', ctermfg = 141, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(
      0,
    ...
    vim.api.nvim_set_hl(
      0,
      'TSConditional',
      { fg = '#EE82EE', ctermfg = 213, bold = (vim.g.aurora_bold == 1) }
    )
    vim.api.nvim_set_hl(0, 'TSRepeat', { link = 'Repeat' })
    vim.api.nvim_set_hl(
      0,
      'TSException',
      { fg = '#ff5874', ctermfg = 204, italic = (vim.g.aurora_italic == 1) }
    )
    ...
    vim.api.nvim_set_hl(
      0,
      'TSURI',
      { fg = '#A6E22D', ctermfg = 148, italic = (vim.g.aurora_italic == 1) }
    )
    vim.api.nvim_set_hl(
      0,
      'TSCurrentScope',
    ...
    vim.api.nvim_set_hl(
      0,
      'TSIdentifier',
      { fg = '#dacfb4', ctermfg = 187, bold = (vim.g.aurora_bold == 1) }
    )
  ...
  colorscheme = function()
    ...
    local function load_basic()
      ...
      vim.api.nvim_set_hl(
        0,
        'NormalFloat',
        { fg = '#dacfb4', bg = bgfl, ctermfg = 187, ctermbg = 236 }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'ColorColumn',
        { fg = 'NONE', bg = '#22202a', ctermfg = 'NONE', ctermbg = 235 }
      )
      vim.api.nvim_set_hl(0, 'Cursor', { bg = '#ddd0f4', ctermbg = 189 })
      vim.api.nvim_set_hl(
        0,
        'CursorIM',
        { fg = '#ddd0f4', bg = '#5f7e97', ctermfg = 189, ctermbg = 66 }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'FoldColumn',
        { fg = '#333042', bg = bg4, ctermfg = 236, ctermbg = 233 }
      )
      vim.api.nvim_set_hl(
        0,
        'SignColumn',
        { fg = 'NONE', bg = bg3, ctermfg = 'NONE', ctermbg = 233 }
      )
      if vim.fn.has('nvim-0.8') == 1 then
      ...
      vim.api.nvim_set_hl(
        0,
        'ModeMsg',
        { fg = '#77d507', bg = bg, ctermfg = 112, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'MoreMsg',
        { fg = '#aab7cf', bg = bg, ctermfg = 146, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'PmenuSbar',
        { fg = 'NONE', bg = '#4f425e', ctermfg = 'NONE', ctermbg = 239 }
      )
      vim.api.nvim_set_hl(
        0,
        'PmenuThumb',
        { fg = 'NONE', bg = '#aab7cf', ctermfg = 'NONE', ctermbg = 146 }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'StatusLine',
        { fg = '#ddd0f4', bg = '#443a54', ctermfg = 189, ctermbg = 238 }
      )
      vim.api.nvim_set_hl(
        0,
        'StatusLineNC',
        { fg = '#777087', bg = '#343047', ctermfg = 243, ctermbg = 236 }
      )
      vim.api.nvim_set_hl(0, 'TabLine', { fg = '#7BA1D0', bg = bg, ctermfg = 110, ctermbg = 234 })
      vim.api.nvim_set_hl(
        0,
        'TabLineFill',
        { fg = '#333042', bg = bg, ctermfg = 236, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'TabLineSel',
      ...
      vim.api.nvim_set_hl(
        0,
        'Title',
        { fg = '#82aaf0', ctermfg = 111, bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(0, 'Visual', { bg = '#3f4060', ctermbg = 239 })
      vim.api.nvim_set_hl(
        0,
        'VisualNOS',
        { fg = '#637077', bg = bg, ctermfg = 243, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'WarningMsg',
        { fg = '#ec5f67', ctermfg = 203, sp = '#821040', undercurl = true }
      )
      vim.api.nvim_set_hl(0, 'WildMenu', { fg = '#777087', bg = bg, ctermfg = 243, ctermbg = 234 })
      vim.api.nvim_set_hl(
        0,
        'EndOfBuffer',
        { fg = '#4f425e', bg = bg3, ctermfg = 239, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'Comment',
        { fg = '#989cbf', ctermfg = 247, italic = (vim.g.aurora_italic == 1) }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'Boolean',
        { fg = '#FF435B', ctermfg = 203, italic = (vim.g.aurora_italic == 1) }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'Function',
        { fg = '#10aef8', ctermfg = 39, bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'Statement',
        { fg = '#F92772', ctermfg = 197, bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'Conditional',
      ...
      vim.api.nvim_set_hl(
        0,
        'Repeat',
        { fg = '#ff7273', ctermfg = 203, italic = (vim.g.aurora_italic == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'Label',
        { fg = '#1aad16', ctermfg = 34, italic = (vim.g.aurora_italic == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'Operator',
        { fg = '#A1EFE4', ctermfg = 158, bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'Keyword',
      ...
      vim.api.nvim_set_hl(
        0,
        'Include',
        { fg = '#D57CD5', bg = bg, ctermfg = 176, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'Define',
      ...
      vim.api.nvim_set_hl(
        0,
        'PreCondit',
        { fg = '#d7ffaf', bg = bg, ctermfg = 193, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'Type',
        { fg = '#67d5b5', ctermfg = 79, bold = (vim.g.aurora_bold == 1) }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'Special',
        { fg = '#FF6347', bg = bg, ctermfg = 203, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'SpecialChar',
        { fg = '#F92772', bg = bg, ctermfg = 197, ctermbg = 'NONE' }
      )
    ...
    async = vim.loop.new_async(vim.schedule_wrap(function()
      ...
      vim.api.nvim_set_hl(
        0,
        'GitGutterAdd',
        { fg = '#9dd067', bg = bg3, ctermfg = 149, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'GitGutterChange',
        { fg = '#4cc7e4', bg = bg3, ctermfg = 80, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'GitGutterDelete',
        { fg = '#f05874', bg = bg3, ctermfg = 204, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'GitGutterChangeDelete',
        { fg = '#7d2c9d', bg = bg3, ctermfg = 91, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'jsGlobalNodeObjects',
      ...
      vim.api.nvim_set_hl(
        0,
        'ALEErrorSign',
        { fg = '#ff5874', bg = bg3, ctermfg = 204, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'ALEWarningSign',
        { fg = '#FD9720', bg = bg3, ctermfg = 208, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'ALEInfoSign',
        { fg = '#addb67', bg = bg3, ctermfg = 149, ctermbg = 234 }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'TelescopeNormal',
        { fg = '#989cbf', bg = bg, ctermfg = 247, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'TelescopePromptBorder',
        { fg = '#4cc7e4', bg = bg, ctermfg = 80, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'TelescopeResultsBorder',
        { fg = '#9ca7e4', bg = bg, ctermfg = 74, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'TelescopePreviewBorder',
        { fg = '#9e71cf', bg = bg, ctermfg = 134, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'TelescopeSelectionCaret',
        { fg = '#66d9ef', bg = bg, ctermfg = 81, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'TelescopeSelection',
      ...
      vim.api.nvim_set_hl(
        0,
        'sqlStatement',
        { fg = '#54CED6', bg = bg, ctermfg = 80, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'sqlKeyword',
        { fg = '#ffbe00', ctermfg = 214, bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        'sqlSpecial',
        { fg = '#DC143C', bg = bg, ctermfg = 161, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'mysqlKeyword',
        { fg = '#C33C4A', bg = bg, ctermfg = 131, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(0, 'mysqlOperator', { link = 'DiagnosticHint' })
      vim.api.nvim_set_hl(
        0,
        'mysqlFunction',
        { fg = '#50c878', bg = bg, ctermfg = 78, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'mysqlStatement',
        { fg = '#A1EFE4', bg = bg, ctermfg = 158, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'mysqlType',
        { fg = '#0fb9e0', bg = bg, ctermfg = 38, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(0, 'Quote', { link = 'Label' })
      vim.api.nvim_set_hl(
        0,
        'yamlFlowString',
        { fg = '#fbfcbf', bg = bg, ctermfg = 229, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'IndentBlanklineChar',
        { fg = '#777087', bg = bg, ctermfg = 243, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
      ...
      vim.api.nvim_set_hl(
        0,
        'jsonNumber',
        { fg = '#fbec9f', bg = bg, ctermfg = 229, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'DiagnosticSignError',
        { fg = '#D93234', bg = bg3, ctermfg = 167, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(0, 'DiagnosticErrorFloating', { link = 'DiagnosticError' })
      vim.api.nvim_set_hl(
        0,
        'DiagnosticWarning',
        { fg = '#bBa03A', bg = bg, ctermfg = 143, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'DiagnosticSignWarn',
        { fg = '#e7dc8c', bg = bg3, ctermfg = 186, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
      ...
      vim.api.nvim_set_hl(
        0,
        'DiagnosticSignInfo',
        { fg = '#7AA6DA', bg = bg3, ctermfg = 110, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
        'DiagnosticInfo',
        { fg = '#7AA6DA', bg = bg, ctermfg = 110, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'DiagnosticHint',
        { fg = '#2ba245', bg = bg, ctermfg = 35, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
        'DiagnosticSignHint',
        { fg = '#ffce51', bg = bg3, ctermfg = 221, ctermbg = 234 }
      )
      vim.api.nvim_set_hl(
        0,
      ...
      vim.api.nvim_set_hl(
        0,
        'cssTagName',
        { fg = '#7fdbca', bg = bg, ctermfg = 116, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'cssClassName',
        { fg = '#9dd067', bg = bg, ctermfg = 149, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'cssAttr',
        { fg = '#dacfb4', bg = bg, ctermfg = 187, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'Underlined',
        { fg = '#67d5b5', bg = bg, ctermfg = 79, ctermbg = 'NONE' }
      )
      ...
      vim.api.nvim_set_hl(
        0,
        'diffComment',
        { fg = '#5f7e97', bg = bg, ctermfg = 66, ctermbg = 'NONE' }
      )
      vim.api.nvim_set_hl(
        0,
      ...
      vim.api.nvim_set_hl(
        0,
        'BufferLineFill',
        { fg = '#282E39', bg = bg2, ctermfg = 236, ctermbg = 236 }
      )
      vim.api.nvim_set_hl(
        0,
        'BuffetCurrentBuffer',
      ...
      vim.api.nvim_set_hl(
        0,
        'helpSectionDelim',
        { fg = '#222222', bg = bg, ctermfg = 235, ctermbg = 'NONE' }
      )

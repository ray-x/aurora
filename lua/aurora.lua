...
local link_ts_v8 = function(bg)
  ...
  vim.api.nvim_set_hl(0, '@emphasis', { fg = ct.yellow3, ctermfg = 228, bold = (vim.g.aurora_bold == 1), undercurl = true, italic = (vim.g.aurora_italic == 1)})
  ...
  vim.api.nvim_set_hl(0, '@text.emphasis', { italic = (vim.g.aurora_italic == 1), bold = (vim.g.aurora_bold == true) })

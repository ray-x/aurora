...
return {
  colorscheme = function()
    ...
    async = vim.loop.new_async(vim.schedule_wrap(function()
      ...
      vim.api.nvim_set_hl(0, "javaScriptDocTags", { fg = "#A6E22D", bg = bg, ctermfg = 148, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "gitcommitDiscardedType", { fg = "#ec5f67", bg = bg, ctermfg = 203, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "gitcommitDiscardedFile", { fg = "#f05874", bg = bg, ctermfg = 204, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "plugStar", { fg = "#fbfcbf", bg = bg, ctermfg = 229, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "plugSha", { fg = "#fbfcbf", bg = bg, ctermfg = 229, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(
        0,
        "cStorageClass",
        { fg = "#50B4DC", bg = bg, ctermfg = 74, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        "cCustomClass",
        { fg = "#b4b0e0", bg = bg, ctermfg = 146, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(
        0,
        "cCustomMemVar",
        { fg = "#50c878", bg = bg, ctermfg = 78, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(0, "cCustom", { fg = "#addb67", bg = bg, ctermfg = 149, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "cType", { link = "typescriptReserved" })
      vim.api.nvim_set_hl(0, "cCustomParen", { fg = "#FD9720", bg = bg, ctermfg = 208, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "cConditional", { link = "Repeat" })
      vim.api.nvim_set_hl(0, "cCustomFunc", { link = "Function" })
      vim.api.nvim_set_hl(
        0,
        "cStatement",
        { fg = "#F92772", bg = bg, ctermfg = 197, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(0, "cppSTLnamespace", { link = "Question" })
      vim.api.nvim_set_hl(0, "cppAccess", { fg = "#A1EFE4", bg = bg, ctermfg = 158, ctermbg = "NONE" })
      vim.api.nvim_set_hl(
        0,
        "cAnsiFunction",
        { fg = "#DDCFBF", bg = bg, ctermfg = 187, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(0, "cRepeat", { link = "Repeat" })
      vim.api.nvim_set_hl(
        0,
        "cSpecial",
        { fg = "#333042", bg = bg, ctermfg = 236, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      ...
      vim.api.nvim_set_hl(0, "yamlKeyValueDelimiter", { fg = "#f05874", bg = bg, ctermfg = 204, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "markdownUrlTitleDelimiter", { fg = "#fbed7d", bg = bg, ctermfg = 228, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "pythonFunction", { fg = "#54CED6", bg = bg, ctermfg = 80, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "pythonExClass", { fg = "#DDCFBF", bg = bg, ctermfg = 187, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "pythonBuiltinObj", { link = "Repeat" })
      vim.api.nvim_set_hl(0, "pythonDot", { fg = "#FD9720", bg = bg, ctermfg = 208, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "pythonBuiltinFunc", { fg = "#DDCFBF", bg = bg, ctermfg = 187, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "vimCommentString", { fg = "#fbed7d", bg = bg, ctermfg = 228, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent1", { fg = "#be9af7", bg = bg, ctermfg = 141, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent2", { fg = "#82aaf0", bg = bg, ctermfg = 111, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent3", { fg = "#addb67", bg = bg, ctermfg = 149, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent4", { fg = "#ecc48d", bg = bg, ctermfg = 222, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent5", { fg = "#FD9720", bg = bg, ctermfg = 208, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "IndentBlanklineIndent6", { fg = "#ff5874", bg = bg, ctermfg = 204, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "DiagnosticWarningFloating", { fg = "#DBC08A", bg = bg, ctermfg = 180, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { fg = "#D93234", bg = bg, ctermfg = 167, ctermbg = "NONE" })
      vim.api.nvim_set_hl(
        0,
        "DiagnosticVirtualTextWarning",
        { fg = "#DBC08A", bg = bg, ctermfg = 180, ctermbg = "NONE" }
      )
      vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { fg = "#99c794", bg = bg, ctermfg = 114, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { fg = "#1aad16", bg = bg, ctermfg = 34, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "DiagnosticHintFloating", { fg = "#1ABC9C", bg = bg, ctermfg = 37, ctermbg = "NONE" })
      vim.api.nvim_set_hl(
        0,
        "LspReferenceText",
      ...
      vim.api.nvim_set_hl(
        0,
        "goBuiltins",
        { fg = "#01d5f1", bg = bg, ctermfg = 45, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1), italic = true }
      )
      vim.api.nvim_set_hl(0, "goConditional", { fg = "#EE82EE", bg = bg, ctermfg = 213, ctermbg = "NONE" })
      vim.api.nvim_set_hl(
        0,
        "goDeclType",
        { fg = "#9e71cf", bg = bg, ctermfg = 134, ctermbg = "NONE", bold = (vim.g.aurora_bold == 1) }
      )
      vim.api.nvim_set_hl(0, "goDirective", { fg = "#CD5C5C", bg = bg, ctermfg = 167, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "goImport", { fg = "#A1EFE4", bg = bg, ctermfg = 158, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "goLabel", { fg = "#FD9720", bg = bg, ctermfg = 208, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "goPackage", { fg = "#EE82EE", bg = bg, ctermfg = 213, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "goRepeat", { fg = "#ffce51", bg = bg, ctermfg = 221, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "goSignedInts", { fg = "#50c878", bg = bg, ctermfg = 78, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "goParen", { fg = "#fbed7d", bg = bg, ctermfg = 228, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "typescriptParens", { fg = "#10aef8", bg = bg, ctermfg = 39, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "typescriptLogicSymbols", { link = "cssImportant" })
      vim.api.nvim_set_hl(0, "typescriptReserved", { fg = "#3649dc", bg = bg, ctermfg = 62, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "typescriptLabel", { link = "DiagnosticHintFloating" })
      vim.api.nvim_set_hl(0, "typescriptFuncName", { fg = "#1aad16", bg = bg, ctermfg = 34, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "typescriptObjectLabel", { fg = "#10aef8", bg = bg, ctermfg = 39, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "typescriptArrowFuncArg", { fg = "#FD9720", bg = bg, ctermfg = 208, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "typescriptInterfaceKeyword", { fg = "#9ece6a", bg = bg, ctermfg = 149, ctermbg = "NONE" })
      ...
      vim.api.nvim_set_hl(0, "javascriptDocNotation", { fg = "#A6E22D", bg = bg, ctermfg = 148, ctermbg = "NONE" })
      vim.api.nvim_set_hl(0, "javascriptDocNamedParamType", { link = "Question" })
      vim.api.nvim_set_hl(0, "javascriptDocParamName", { fg = "#fbed7d", bg = bg, ctermfg = 228, ctermbg = "NONE" })

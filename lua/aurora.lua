...
return {
    ...
    = true})
		...
		vim.api.nvim_set_hl(0, "LspReferenceText", { bg="#3f3047",  ctermbg=239, sp="#FD9720", bold = (vim.g.aurora_bold==1), underline= true })
		vim.api.nvim_set_hl(0, "LspReferenceRead", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", bold = (vim.g.aurora_bold==1), underline= true })
		vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", bold = (vim.g.aurora_bold==1), underline= true })

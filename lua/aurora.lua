return {
	colorscheme = function() 
		...
		vim.api.nvim_set_hl(0, "ClapDisplay", {fg="#aab7cf", bg="#211c2f", ctermfg=146, ctermbg=234, sp="#f05874", bold = (vim.g.aurora_bold==1), undercurl= true })
		...
		vim.api.nvim_set_hl(0, "LspReferenceText", { bg="#4f4764",  ctermbg=239, sp="#FD9720", bold = (vim.g.aurora_bold==1), undercurl= true })
		...
		vim.api.nvim_set_hl(0, "Search", {fg="NONE", bg="#4f5070", ctermfg="NONE", ctermbg=239, sp="#F92772", bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
